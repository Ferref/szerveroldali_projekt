    ...
    <div class="row mx-0 my-3">
        <div class="col-12" id="categoriesContainer">';
            foreach($kategoriak as $k) {
                $kategoriakContent .= '<label class="category-frame rounded-10 py-1 ps-3 pe-2 c-pointer me-2" for="kat'.$i.'">
                <input class="kat" type="checkbox" name="categories[]" value="'.$i.'" id="kat'.$i.'" hidden>
